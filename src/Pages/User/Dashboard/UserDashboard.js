	...
	return (
		<div className="flex justify-start items-start h-screen w-scree">
			<div className="bg-gray-300 px-8 py-4 h-full space-y-4 flex-col shadow-lg flex-shrink-0">
				...
				<div>
					<Link to={`/user/${userData.username}/dashboard/addsnippet`} className="bg-darkBlue tracking-widest rounded-md shadow-md px-3 py-1 text-sm text-gray-50 font-thin flex justify-center items-center">
