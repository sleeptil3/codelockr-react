		...
		<div className="flex flex-col sm:flex-row justify-start items-center sm:items-start">
			<div className="sm:ml-5 w-full sm:w-max h-max ">
										...
										return (
											<li
												className={`my-1 cursor-pointer py-1 px-2 w-max ${
													filter === folder._id ? "hover:text-gray-50 bg-gradient-to-tr from-darkBlue to-red-800 text-gray-50 rounded-md" : "hover:text-red-600"
												}`}
												id={folder._id}
				...
				<div className="hidden sm:flex mt-4 justify-center">
					<Link to={`/user/${userData.username}/dashboard/addsnippet`} onClick={handleAddSnippet} className="btn-primary w-4/6 p-2">
