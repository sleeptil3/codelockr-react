        ...
        <div>
            ...
            <div data-aos="fade-up" className="bg-gray-900 relative w-full px-7 py-12 mt-11 shadow-md">
                <div className="tracking-wide container text-sm sm:text-base space-y-4 sm:space-y-4 mx-auto sm:px-8 lg:px-24">
                    ...
                    <p className="font-bold text-lg sm:text-xl pt-4">Simply put, CODELOCKR is a clean, simple way to store your coding stuff. Sticky notes just don't cut it.</p>
                    <p className="font-thin font-widest">👉🏾 Do you always finding yourself firing up <code className="text-green-500">create-react-app</code> and forgetting what important <code className="text-yellow-500">npm</code> installs you like in a base project?
                    </p>
                    ...
                    <p>Built from the ground-up for zippy speed with no-frills, CODELOCKR enables web developers and software engineers to have easy access to their coding 'Snippets', neatly organized into folders, and looking fantastic. CODELOCKR supports{" "}<span className="text-pink-500">highlighting</span> and <code className="text-red-500">formatting</code> in over 160 languages.
                    </p>
                    <p>
