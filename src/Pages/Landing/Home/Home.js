		...
		<div>
			<div data-aos="zoom-in" className="mt-4 sm:mt-10 sm:flex-none h-96 sm:h-auto mb-4 sm:mb-8">
				<div className="relative sm:max-w-screen-lg mx-auto sm:h-96 flex flex-col items-center">
					<div className="w-10/12 h-44 flex justify-center items-center py-4 px-2 z-20 bg-gradient-to-b from-darkBlue to-black shadow-lg sm:absolute sm:left-0 sm:w-1/2 sm:h-96 sm:ml-10 sm:pl-20">
						<div className="mx-auto space-y-2">
							...
							<p className="text-xs pl-16 pr-4 sm:pl-8 sm:pr-10 font-mono sm:text-xl">
								(<span className="text-yellow-500">code</span>, <span className="text-green-600">dependencies</span>, <span className="text-pink-500">project setup</span>,{ " " }
					...
					>
						<div className="">
							<h1 className="text-gray-900 text-base sm:text-2xl p-8 sm:pr-4">Because your notes app wasn't built for that.</h1>
			...
			<div data-aos="fade-up" className="bg-gray-900 relative w-full p-7 shadow-md">
				<div className="tracking-wide container text-xs sm:text-md space-y-4 sm:space-y-4 mx-auto sm:px-8 lg:px-24">
					...
					<p className="font-bold text-lg sm:text-xl pt-4">Simply put, CODELOCKR is a clean, simple notes app, but designed with the coder in mind.</p>
					<p className="font-thin font-widest">
						👉🏾 Do you always finding yourself firing up <code className="text-green-500">create-react-app</code> and forgetting what important <code className="text-yellow-500">npm</code> installs you
						like in a base project?
					</p>
					...
					<p className="font-bold text-lg sm:text-xl pt-4">Well, CODELOCKR is a place to store all of that.</p>
					<p>
						CODELOCKR enables web developers and software engineers to have easy access to their coding 'Snippets', neatly organized into folders, and looking fantastic. CODELOCKR supports{ " " }
						<span className="text-pink-500">highlighting</span> and <code className="text-red-500">formatting</code> in over 160 languages.
					</p>
					<p>
						You can also buddy-up with friends or co-workers and share Snippets in the <strong>LockrRoom</strong>!
					</p>
					<br />
					<p onClick={ () => setShowRegistration(true) } className="inline cursor-pointer underline hover:text-red-600 font-bold">
			...
			<div data-aos="fade-up" className="bg-gray-900 mt-8 w-full p-7 shadow-md">
				<div className="tracking-wide container text-xs sm:text-md space-y-4 sm:space-y-4 mx-auto sm:px-8 lg:px-24">
					<h1 className="text-lg font-normal sm:text-xl mb-4">
						What are people saying about <span className="tracking-wider font-black">CODELOCKR</span>?
					</h1>
				</div>
				<div className="tracking-wide container text-xs sm:text-md space-y-8 sm:space-y-4 mx-auto sm:px-8 lg:px-24 flex flex-col xl:flex-row xl:flex-wrap justify-center xl:justify-start">
