...
export default function Landing() {
	return (
		<div className="text-gray-50 flex flex-col justify-between min-h-screen">
			<div>
				<header className="w-full border-b-4 sm:border-b-8 border-gray-900 shadow-md py-3 sm:py-5 flex justify-center items-center bg-gradient-to-b from-darkBlue to-red-800">
