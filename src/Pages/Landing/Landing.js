...
export default function Landing() {
	return (
		<div className="text-gray-50 flex flex-col justify-between min-h-screen">
			<div>
				<header className="border-b-8 border-gray-900 shadow-md w-full py-5 flex justify-center items-center bg-gradient-to-b from-darkBlue to-red-800">
					<div>
						...
						<h1 className="text-center block text-4xl font-bold tracking-widest">CODELOCKR</h1>
					</div>
				</header>
				<RegistrationForm />
				<main>
