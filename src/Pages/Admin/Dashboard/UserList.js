...
export default function UserList() {
	...
	return (
		<div className="mb-10">
			<h2 className="text-3xl font-bold uppercase mb-6">Manage Users</h2>
			<input className="mb-8 bg-transparent text-lg py-1" type="text" onChange={handleChange} value={filter} />
