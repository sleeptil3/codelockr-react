			...
			<div className="sm:cs-border-outset shadow-lg px-4 sm:px-8 space-y-2 pb-4 pt-2 sm:pt-4 sm:pb-8 sm:space-y-4 bg-gray-900">
				<div className="flex justify-between items-baseline">
					...
					<div className="flex">
						...
						{isCopied ? (
							<svg className="ml-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="22" height="22" fill="green">
							...
							<button title="Copy to clipboard" className="flex ml-3 cursor-pointer" onClick={copySnippet}>
								<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" className="fill-current hover:text-red-600">
