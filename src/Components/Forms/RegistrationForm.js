						...
						<div>
							...
							<ul className="mt-1">
								{ displayErrors.map((error) => {
									return (
										<li className="text-red-500 text-sm list-item list-disc list-inside" key={ uuid() }>
											{ error }
										</li>
									);
								}) }
						...
						<div className="font-thin tracking-wider text-xs sm:text-sm text-gray-50 flex flex-col items-center justify-evenly w-full px-4 sm:px-8">
							<label className={ `w-full ${ displayErrors && !formData.firstName ? "border-l-2 pl-4 border-red-600" : null }` }>
								<input
									...
									className="p-0 m-0 mt-4 focus:ring-0 border-0 border-b border-gray-200 bg-transparent text-lg font-thin tracking-widest w-full"
									id="firstName"
									type="text"
							...
							<label className={ `w-full ${ displayErrors && !formData.lastName ? "border-l-2 pl-4 border-red-600" : null }` }>
								<input
									...
									className="p-0 m-0 mt-4 focus:ring-0 outline-none border-0 border-b border-gray-200 bg-transparent text-lg font-thin tracking-widest w-full"
									id="lastName"
									type="text"
