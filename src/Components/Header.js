...
export default function Header({ userData, handleLogout }) {
	...
	return (
		<div className="relative z-40 w-full">
			<nav className="shadow-lg border-b-4 border-gray-900 relative z-40 py-3 px-8 w-full text-gray-50 bg-gradient-to-r from-darkBlue to-red-800 flex justify-between items-center">
				<Link to={`/user/${userData.username}/dashboard`} className="flex justify-start items-center space-x-5">
				...
				<div onMouseEnter={handleSlide} className="cursor-pointer flex justify-start items-center space-x-5">
			...
			<div onMouseLeave={handleSlide} className={`shadow-xl absolute z-30 right-10 -top-20 px-3 -mt-2 bg-gray-900 text-gray-50 transition-transform transform ${slide}`}>
