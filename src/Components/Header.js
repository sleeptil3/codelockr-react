...
export default function Header({ userData, handleLogout }) {
	...
	return (
		<div className="fixed z-40 w-full">
			<nav className="relative z-40 py-3 px-8 w-full text-gray-50 bg-gradient-to-r from-darkBlue blue to-black flex justify-between items-center">
			...
			<div className={`shadow-2xl absolute z-30 right-10 -top-16 px-3 -mt-2 border border-gray-900 border-t-0 bg-gray-300 text-gray-900 transition-transform transform ${slide}`}>
