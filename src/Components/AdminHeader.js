...
export default function AdminHeader({ handleLogout }) {
	...
	return (
		<div className="fixed z-40 w-full">
			<nav className="relative z-40 py-3 px-8 w-full text-gray-50 bg-gradient-to-tr from-darkBlue to-red-800 flex justify-between items-center">
				<div className="flex justify-start items-center space-x-5">
					...
					<h2 className="text-2xl font-bold uppercase">CODELOCKR <span className="font-thin text-lg tracking-widest text-gray-300">• ADMIN DASHBOARD</span></h2>
				</div>
				<div onClick={handleSlide} className="cursor-pointer flex justify-start items-center space-x-5">
					<h3 className="text-sm font-thin uppercase tracking-widest">ADMINISTRATOR</h3>
			...
			<div className={`shadow-xl absolute z-30 right-10 -top-16 px-3 -mt-2 bg-gray-900 text-gray-50 transition-transform transform ${slide}`}>
				<ul onClick={handleSlide} className="p-4 flex-col font-thin text-sm space-y-2">
