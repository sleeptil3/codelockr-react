...
var hljs = (function () {
	...
	var _ = Object.freeze({
		...
		SHEBANG: (e = {}) => {
			...
			return (
				e.binary &&
					(e.begin = ((...e) => e.map((e) => g(e)).join(""))(t, /.*\b/, e.binary, /\b.*/)),
				a(
					{
						className: "meta",
						begin: t,
				...
				if (((E = a), "begin" === a.type))
					return (function (e) {
						...
						return (
							...
							n.skip
								? (M += t)
								: (n.excludeBegin && (M += t), g(), n.returnBegin || n.excludeBegin || (M = t)),
							h(n),
		...
		function x(e) {
			...
			const n = ((e) => {
				...
				if (n) {
					...
					return (
						t ||
							(z(o.replace("{}", n[1])), z("Falling back to no-highlight mode for this block.", e)),
						t ? n[1] : "no-highlight"
					)
				}
			...
			Object.assign(e, {
				...
				registerLanguage: (t, i) => {
					...
					try {
						...
						if ((U("Language definition for '{}' could not be registered.".replace("{}", t)), !r))
							throw e
						U(e), (s = g)
					}
					s.name || (s.name = t),
		...
		return (s) => {
			...
			const a = {
				...
				i = {
					begin: /<<-?\s*(?=\w+)/,
					starts: {
						contains: [s.END_SAME_AS_BEGIN({ begin: /(\w+)/, end: /(\w+)/, className: "string" })],
					},
				},
				...
				contains: [
					{
						...
						contains: [
							...
							c,
							{
								...
								contains: [
									{ className: "meta", begin: /<![a-z]/, end: />/, contains: [r, c, g, l] },
								],
							},
						],
					},
		...
		return (e) => {
			...
			const l = {
				...
				c = {
					...
					begin: "@" + e.UNDERSCORE_IDENT_RE,
					contains: [
						{ begin: /\(/, end: /\)/, contains: [e.inherit(r, { className: "meta-string" })] },
					],
				},
				o = a,
		...
		return (e) => {
			...
			return {
				...
				contains: [
					{
						begin: t(...o),
						keywords: { $pattern: /[\w\.]+/, keyword: l.concat(o), literal: a, type: i },
					},
					{
						className: "type",
